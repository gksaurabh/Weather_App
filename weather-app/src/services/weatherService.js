...
const API_KEY = "1d1ae7d895fcc726b82df8ff41ca3804";
...
const formatCurrentWeather = (data) => {
    ...
    return {lat, lon, temp,temp_max,temp_min,feels_like,humidity,speed,name,dt,country,sunrise,sunset,details,icon}
};
